    ...
    return (
        <main className='min-h-screen w-full h-full flex justify-center lg:grid lg:grid-cols-2'>
            ...
            <div className='flex flex-col items-center justify-center gap-5'>
                ...
                <a className="py-2 px-4 max-w-md flex justify-center items-center bg-gray-600 w-72 transition ease-in duration-200 text-center text-base font-semibold rounded-lg hover:bg-gray-700 text-white" href="https://backend-coderhouse-csas.onrender.com/api/users/github">
