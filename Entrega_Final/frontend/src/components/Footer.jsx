    ...
    <>
        ...
        <div className='bg-[#f3f3f3] py-2'>
            <div className='container mx-auto flex-col md:flex-row gap-3 flex justify-between items-center'>
                ...
                <p>Software developed by <a className='text-myGreen hover:text-myLightGreen' target='__blank' href="https://github.com/aibacetat/backend-entregas">AibacetDev</a></p>
            </div>
        </div>
    </>
  )
